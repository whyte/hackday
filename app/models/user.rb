class User < ActiveRecord::Base
  ...
  devise :database_authenticatable, :registerable,
   ...
   attr_accessible :first_name, :last_name, :part_type, :school_company, :twitter, :email, :password, :password_confirmation, :current_password, :remember_me, :phone, :bio, :avatar, :crop_x, :crop_y, :crop_w, :crop_h
